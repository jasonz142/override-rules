...
(() => {
  ...
  function buildFeatureFlags(args) {
    return {
      groupType: args.grouptype !== void 0 ? parseGroupType(args) : 1,
      ipv6Enabled: parseBool(args.ipv6),
      fullConfig: args.full !== void 0 ? parseBool(args.full) : true,
      keepAliveEnabled: args.keepalive !== void 0 ? parseBool(args.keepalive) : true,
      fakeIPEnabled: args.fakeip !== void 0 ? parseBool(args.fakeip) : true,
      quicEnabled: parseBool(args.quic),
      regexFilter: args.regex !== void 0 ? parseBool(args.regex) : true,
      tunEnabled: args.tun !== void 0 ? parseBool(args.tun) : true,
  ...
  var init_rules = __esm({
    "src/rules.ts"() {
      ...
      baseRules = [
        ...
        //全球游戏平台下载 CDN
        `GEOSITE,CATEGORY-PORN,${PROXY_GROUPS.SELECT}`,
        //porn
        `GEOSITE,category-games,${PROXY_GROUPS.SELECT}`,
        // 国外游戏
        `GEOSITE,geolocation-!cn,${PROXY_GROUPS.SELECT}`,
        // 强力国外兜底
